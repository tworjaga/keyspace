...
License:        MIT
URL:            https://github.com/bruteforce-tool/bruteforce-tool
...
%description
BruteForce Tool is a comprehensive password cracking application featuring:
...
%changelog
* Mon Feb 05 2026 BruteForce Tool Team <admin@bruteforce-tool.local> - 1.0.0-1
